...
//    }
    ...
    public void testCreateInvalidRecipeAmtCoffee() throws InvalidValueException {
        InvalidValueException thrown = assertThrows(InvalidValueException.class, () -> new Recipe("Coffee", 50, -1, 0, 1, 0));
    ...
    public void testCreateInvalidRecipeAmtMilk() throws InvalidValueException {
        InvalidValueException thrown = assertThrows(InvalidValueException.class, () -> new Recipe("Milk", 50, 0, -1, 2, 0));
    ...
    public void testCreateInvalidRecipeAmSugar() throws InvalidValueException {
        InvalidValueException thrown = assertThrows(InvalidValueException.class, () -> new Recipe("Coffee", 50, 2, 0, -1, 0));
    ...
    public void testCreateInvalidRecipeAmtChocolate() throws InvalidValueException {
        InvalidValueException thrown = assertThrows(InvalidValueException.class, () -> new Recipe("Coffee", 50, 0, 2, 0, -1));
    ...
    public void testCreateInvalidRecipeZeroIngredients() throws InvalidValueException {
        InvalidValueException thrown = assertThrows(InvalidValueException.class, () -> new Recipe("Empty", 50, 0, 0, 0, 0));
        assertEquals("Zero ingredients", thrown.getMessage());
    }

    @Test
    public void testCreateInvalidRecipePriceZero() throws InvalidValueException {
        InvalidValueException thrown = assertThrows(InvalidValueException.class, () -> new Recipe("Free", 0, 1, 0, 1, 0));
    ...
    public void testCreateInvalidRecipeNegativePrice() throws InvalidValueException {
        InvalidValueException thrown = assertThrows(InvalidValueException.class, () -> new Recipe("Gimme money", -1, 1, 0, 1, 0));
        assertEquals("Price must be a positive integer", thrown.getMessage());
    }

    @Test
    public void testCreateInvalidRecipeEmptyName() throws InvalidValueException {
        InvalidValueException thrown = assertThrows(InvalidValueException.class, () -> new Recipe("", 50, 1, 0, 1, 0));
        assertEquals("Invalid name", thrown.getMessage());
    }

    @Test
    public void testCreateInvalidRecipeNullName() throws InvalidValueException {
        InvalidValueException thrown = assertThrows(InvalidValueException.class, () -> new Recipe(null, 50, 1, 0, 1, 0));
        assertEquals("Invalid name", thrown.getMessage());
    }
